...
class JavaVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationController?.navigationBar.topItem?.title = "Java!"
    ...
    @IBAction func learnCodePressed(_ sender: Any) {
        if let presentedViewController = self.storyboard?.instantiateViewController(withIdentifier: "JavaWeb") as? JavaWeb {
