...
class DataStructuresVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationController?.navigationBar.topItem?.title = "Data Structures!"
        ...
        let url = URL(string: "https://en.wikipedia.org/wiki/Data_structure")
